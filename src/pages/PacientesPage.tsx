...
export function PacientesPage() {
    ...
    if (editingClient) {
      ...
      Object.keys(editingClient).forEach((key) => {
        setValue(
          ...
          editingClient[key as keyof Client]
        );
      });
      setIsModalOpen(true);
    }
  ...
  const openModalForNew = () => {
    ...
    reset({ consentimento_lgpd: false });
    setIsModalOpen(true);
  };
  ...
  return (
    <main className="p-6">
            ...
            <Tabs defaultValue="pessoal">
              ...
              <TabsContent value="pessoal">
                <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input id="nome_social" {...register("nome_social")} />
                  </div>
                  <div>
                    <Label htmlFor="genero">Gênero</Label>
                    <select
                      {...register("genero")}
                      className="h-10 w-full rounded-md border border-slate-300 bg-transparent px-3 dark:border-slate-700"
                    >
                  ...
                  <div>
                    ...
                    <Input id="pronomes" {...register("pronomes")} />
                  </div>
                </div>
              </TabsContent>
              <TabsContent value="contato" className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="telefone_principal">
                      Telefone Principal
                    </Label>
                    <Input
                  ...
                  <div className="md:col-span-2">
                    <h4 className="font-medium mb-2 dark:text-slate-200">
              ...
              <TabsContent value="adicionais">
                <div className="p-6 space-y-4">
                  ...
                  <div>
                    <Label htmlFor="campo_observacoes_iniciais">
                      Observações Iniciais
                    </Label>
                    <textarea
                      {...register("campo_observacoes_iniciais")}
                      className="min-h-[80px] w-full rounded-md border border-slate-300 bg-transparent px-3 py-2 dark:border-slate-700"
                    />
                  </div>
      ...
      >
        ...
        <CardContent>
          <p>
            Tem certeza que deseja apagar este paciente? Esta ação não pode ser
            desfeita.
          </p>
        </CardContent>
        <div className="flex justify-end p-6 pt-0 space-x-2">
          <Button variant="ghost" onClick={() => setDeletingClientId(null)}>
            Cancelar
          </Button>
